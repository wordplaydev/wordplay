...
import { getTextTransition, graphemes } from '@output/getTextTransition';
import {
...
import type { TextEffect } from '@output/OutputAnimation';
import { getRandomPool } from '@output/textEffectPool';
