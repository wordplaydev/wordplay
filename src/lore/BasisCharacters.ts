...
const CharactersSet = {
    // Parsing
    Unparsable: { symbols: UNPARSABLE_SYMBOL },
    Source: { symbols: SOURCE_SYMBOL },
    // Names
    ...
    This: { symbols: THIS_SYMBOL },
    Basis: { symbols: NATIVE_SYMBOL },
    Borrow: { symbols: BORROW_SYMBOL },
    // Functions
    Program: { symbols: '📄' },
    ...
    Block: { symbols: EVAL_OPEN_SYMBOL + EVAL_CLOSE_SYMBOL },
    Conditional: { symbols: QUESTION_SYMBOL },
    NoneOr: { symbols: COALESCE_SYMBOL },
    Match: { symbols: MATCH_SYMBOL },
    Conversion: { symbols: CONVERT_SYMBOL },
    Translate: { symbols: TRANSLATE_SYMBOL },
    Insert: { symbols: TABLE_OPEN_SYMBOL + SUM_SYMBOL },
    Select: { symbols: TABLE_OPEN_SYMBOL + QUESTION_SYMBOL },
    Update: { symbols: TABLE_OPEN_SYMBOL + BIND_SYMBOL },
    ...
    TextLiteral: { symbols: FUNCTION_SYMBOL },
    Template: { symbols: CODE_SYMBOL },
    Markup: { symbols: '¶' },
    Formatted: { symbols: FORMATTED_SYMBOL },
    ...
    Locale: { symbols: LOCALE_SYMBOL },
    Set: { symbols: SET_OPEN_SYMBOL + SET_CLOSE_SYMBOL },
    SetOrMapAccess: { symbols: SET_OPEN_SYMBOL + SET_CLOSE_SYMBOL },
    Table: { symbols: TABLE_OPEN_SYMBOL + TABLE_CLOSE_SYMBOL },
    Dimension: { symbols: MEASUREMENT_SYMBOL },
    Placeholder: { symbols: PLACEHOLDER_SYMBOL },
    Mention: { symbols: MENTION_SYMBOL },
    Never: { symbols: NEVER_SYMBOL },
    Unknown: { symbols: UNKNOWN_SYMBOL },
    ...
    Change: { symbols: CHANGE_SYMBOL },
    Initial: { symbols: INITIAL_SYMBOL },
    // Documentation
    Doc: { symbols: DOCS_SYMBOL + DOCS_SYMBOL },
