...
test.each([
    ...
    ['src/components/app/Page.svelte', 517, 3.85],
    ['src/routes/[[locale]]/+page.svelte', 532, 3.94],
    ['src/routes/[[locale]]/galleries/+page.svelte', 536, 3.95],
    ['src/routes/[[locale]]/projects/+page.svelte', 543, 3.97],
