...
export default abstract class Conflict {
    ...
    getSecondaryExplanation(_: Context): Translations { return WRITE_DOCS };

    isMinor() { return this.#minor; }
    getExplanation(context: Context, lang: LanguageCode): string { return this.getPrimaryExplanation(context)[lang]; }
