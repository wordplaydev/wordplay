...
export const BOOLEAN_NATIVE_TYPE_NAME = "boolean";

export const MEASUREMENT_NATIVE_TYPE_NAME = "measurement";
...
export const CONVERSION_NATIVE_TYPE_NAME = "conversion";

export const FUNCTION_NATIVE_TYPE_NAME = "function";

export const NAME_NATIVE_TYPE_NAME = "name";
