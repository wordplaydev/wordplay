...
export default class Refer {
    ...
    constructor(creator: (name: string, op?: string) => Node, definition: Definition) {
        this.creator = creator;
        this.definition = definition;
    }

    getNode(languages: LanguageCode[]) {
        return this.creator(this.definition.getTranslation(languages), this.definition.getTranslation(["😀"]));
    }
