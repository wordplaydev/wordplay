...
test("Test scoping", () => {
    ...
    expect(prop?.getDefinitionOfNameInScope("bystander", context)).toBeDefined();
    expect(defs?.find(n => n instanceof Bind && n.hasName("sneaky"))).toBeUndefined();
    expect(defs?.find(n => n instanceof Bind && n.hasName("bystander"))).toBeDefined();
