...
- 🥁 We added fifteen instruments. Twelve are real recordings — piano, guitar, violin, drums, flute, trumpet, saxophone, bell, didgeridoo, a dog, and a cat twice over: `cat` is a whole kit of meows, and `pitchedCat` is one meow you can play a tune with. The other three are synthesizers, which is what they're meant to sound like. (#390)
