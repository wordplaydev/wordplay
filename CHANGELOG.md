...
- 🎨 You can now watch music as well as hear it. In settings, choose an orchestra of instruments, a light show that colors the stage, a mood cloud, or nothing at all. (#390)
- 🌀 The mood cloud reads your song and shows how it feels. It looks at the scale, how fast it goes, how high or low it sits, how much of it is drums, and how long the notes are, then gathers a cloud of color and shape along the floor of the stage that shifts as the music does. Sad music and happy music look different even when they play the same notes. (#390)
