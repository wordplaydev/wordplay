 ...
 * culturally specific and don't suit Wordplay's multilingual audience. The
 * principles below are the WCAG plain-language techniques: short single-idea
 * sentences, common words (unusual ones are defined by the glossary),
 * single-topic paragraphs, explained abbreviations, active voice, direct action
 * verbs, and no idioms or metaphors.
 *
 * Keep in sync with src/locale/readingLevel.ts (the functions↔src wall prevents
